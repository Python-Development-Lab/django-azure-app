...
echo "=== Creating docs/playbooks/ ==="
mkdir -p docs/playbooks

cat > docs/playbooks/PLAYBOOK-TEMPLATE.md << 'EOF'
...
echo "OK: PLAYBOOK-TEMPLATE.md created"

cat > docs/playbooks/T1110-http-brute-force.md << 'EOF'
...
echo "OK: T1110-http-brute-force.md created"
...
echo ""
echo "  git add docs/playbooks/"
echo "  git status"
echo "  git commit -m \"Add incident response playbook template and T1110 playbook\""
